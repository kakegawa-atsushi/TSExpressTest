declare module "express" {
   ...
   // Connect middleware
    ...
    export function logger(level: string): (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
    export function favicon(): (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
    ...
    export interface ExpressServer {
        ...
        router: (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
    }
